...
//inicializa el juego para empezar (matrices de cuadrante, tablero y posición de inicio y final)
function init ()
{
...
//función para ratón (mismo código pero el valor de la cuadrante se coge con clic)
...
function clicBal (bal)
{
	...
	if(enFilaColumna(currRow, queryRow, currCol, queryCol))
	{
		...
		{
			alerts.innerText = "cuadrante no es válida, debe tener el mimso número o color";
		}
	}

	else {if( currVal != queryVal ||  currClas != queryClas) alerts.innerText = "cuadrante no es válida, debe estar en la misma fila o columna";}
}
